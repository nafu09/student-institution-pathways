            ...
            <Container className="max-w-md">
              <div className="bg-white rounded-lg shadow-sm border p-6 md:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="text-sm text-muted-foreground space-y-2">
                    <div className="flex items-start">
                      ...
                      <p>Access to worldwide educational institutions</p>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-4 w-4 mr-2 text-primary mt-0.5" />
                      <p>Apply for BSc, MS, and PhD programs</p>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="h-4 w-4 mr-2 text-primary mt-0.5" />
                ...
                <div className="mt-8 pt-6 border-t text-center text-sm text-muted-foreground">
                  <Link to="/institution/register" className="hover:text-primary">
                    Register as an institution instead
                  </Link>
                </div>
              </div>
            </Container>
